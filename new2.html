...
<div class="cont">
    ...
    <form action="/amulya1.php" method="post">
<label for="from1"><b>Enter id</b></label>
<input type="text" class="input-block-level" placeholder="Enter city" name="id" required />


<button class="btn btn-large btn-primary" type="submit" name="btn-signup">SEARCH</button>
</form>
</div>
